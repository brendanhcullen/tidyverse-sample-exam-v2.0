...
:::alert
There is of course no one correct way to solve each of these questions. I've included the first solutions that first came to my mind when I did this practice exam. If you find a mistake or a much better solution, feel free to submit a pull request on [Github](https://github.com/brendanhcullen/tidyverse-sample-exam-v2.0).
:::
...
:::book
You can read about the RStudio Instructor Training and Certification Program [here](https://education.rstudio.com/trainers/). There is [another sample exam](https://education.rstudio.com/blog/2020/02/instructor-certification-exams/#tidyverse-certification-exam) available with [solutions](https://marlycormar.github.io/tidyverse_sample_exam/sample_exam_sols/sols.html), courtesy of [Marly Gotti](https://www.marlygotti.com/). I also reflected on my experience and shared some of my preparation materials [here](https://bcullen.rbind.io/post/2020-09-03-reflections-on-rstudio-instructor-training/). Feel free to [reach out](https://twitter.com/_bcullen) with any questions!
:::
