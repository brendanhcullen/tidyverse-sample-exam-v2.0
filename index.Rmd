...
:::toggle
By default, the code for each question is hidden. You can toggle the code on and off by clicking `Code`/`Hide` at the top right of each chunk or `Code > Show All Code` at the top right of this document.
:::
